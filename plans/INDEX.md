...
| assistant-context-compaction | 本地实现与离线验证完成；S09 真实收益与重复性能样本待验收（2026-09-12） | 8/9，S09 离线部分完成 | [plan](assistant-context-compaction/plan.md) · [ADR-041](../docs/adr/041-assistant-context-compaction.md) · [验证报告](../docs/test-reports/assistant-context-compaction.md) · [实现增量](../docs/changelogs/assistant-context-compaction/story-01-to-09-implementation/2026-09-12-001-稳定上下文与不可变摘要链实现.md) |
...
| ai-task-project-terminology | 已完成（2026-09-11，388 项相关回归与离屏布局验证通过） | 直接实现 | [plan](ai-task-project-terminology/plan.md) · [增量记录](../docs/changelogs/ai-task-project-terminology/implementation/2026-09-11-001-AI任务项目术语状态与查看入口.md) |
| terminology-localization-profiles | 已完成；S09 工作台 UI 追加改版已记录（2026-09-10），来源直连与自动同步未实现 | 9/9 | [plan](terminology-localization-profiles/plan.md) · [S01-06 增量记录](../docs/changelogs/terminology-localization-profiles/story-01-to-06-implementation/2026-09-06-001-本体汉化术语配置档与非破坏性切换.md) · [S08 增量记录](../docs/changelogs/terminology-localization-profiles/story-08-source-to-naming-scheme/2026-09-06-001-从单个术语来源创建译名方案.md) · [S09 增量记录](../docs/changelogs/terminology-localization-profiles/story-09-workbench-scheme-hub/2026-09-06-001-译名方案入口归位术语工作台.md) · [S09 UI 改版增量](../docs/changelogs/terminology-localization-profiles/story-09-workbench-scheme-hub/2026-09-10-002-术语工作台紧凑布局与已选副本浏览.md) |
...
| [agent-upgrade](agent-upgrade/plan.md) | 部分已废除（旧记忆）；其他范围 `partially-verified` | platform-contract-foundation-v2 / unified-task-translation-runtime-v2 |
| [agent-tool-expansion](agent-tool-expansion/plan.md) | `partially-verified` | platform/I-O/task/ParaTranz V2 |
| [smart-assistant-refactor](smart-assistant-refactor/plan.md) | 部分已废除（旧记忆）；其他范围 `partially-verified` | platform-contract-foundation-v2 / persistence V2 |
...
| smart-assistant-qa-fix | 部分已废除：S03/S05/S07 的旧记忆项；其他范围保持原状态 | 7 | [plan](smart-assistant-qa-fix/plan.md) |
| smart-assistant-refactor | 部分已废除：S04 子任务 B；其他范围保持原状态 | 4 | [plan](smart-assistant-refactor/plan.md) |
...
| session-manager | ✅ 全部完成 | 3 | [plan](session-manager/plan.md) · [007-恢复轮次与连续裁剪修复](../docs/changelogs/session-manager/story-01-session-manager/2026-09-12-007-修复会话恢复轮次计数与连续裁剪.md) |
