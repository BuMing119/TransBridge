...
| Epic | 状态 | Stories | 文档 |
|---|---|---:|---|
| terminology-localization-profiles | 已完成（2026-09-06，支持从单个术语来源创建方案） | 8/8 | [plan](terminology-localization-profiles/plan.md) · [S01-06 增量记录](../docs/changelogs/terminology-localization-profiles/story-01-to-06-implementation/2026-09-06-001-本体汉化术语配置档与非破坏性切换.md) · [S08 增量记录](../docs/changelogs/terminology-localization-profiles/story-08-source-to-naming-scheme/2026-09-06-001-从单个术语来源创建译名方案.md) |
