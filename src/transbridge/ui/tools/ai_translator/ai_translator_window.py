...
class AITranslatorWindow(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._terminology_workbench_requested = terminology_workbench_requested
    ...
    def on_save_term_source_as_scheme(self) -> None:
        if self._terminology_workbench_requested is None:
            QMessageBox.information(self, "译名方案", "请从项目术语工作台管理和创建译名方案。")
            return
        self._terminology_workbench_requested()
