...
ROUND1_CATEGORIES: dict[str, set[str]] = {
    ...
    "物品": {
        ...
        "WEAP:DESC", "WEAP:FULL", "FLOR:FULL", "AMMO:DESC",
        "PROJ:FULL"
    },
    "法术技能": {
        "ENCH:FULL", "EXPL:FULL", "MESG:DESC", "MESG:FULL", "MESG:ITXT",
        "MGEF:DNAM", "MGEF:FULL", "PERK:FULL", "PERK:DESC" ,"PERK:EPF2",
        "SHOU:FULL", "SHOU:DESC",
        "SPEL:DESC", "SPEL:FULL", "AVIF:FULL", "AVIF:DESC", "PERK:EPFD"
    },
    "任务名": {"QUST:FULL"},
...
ROUND3_CONTEXTS: set[str] = {
    "BOOK:DESC", "QUST:NNAM", "QUST:CNAM", "LSCR:DESC", "SCRL:DESC"
}
...
EXPORT_CATEGORIES: dict[str, list[str]] = {
    ...
    "法术_龙吼_技能.json": [
        "ENCH:FULL", "EXPL:FULL", "MESG:DESC", "MESG:FULL", "MESG:ITXT",
        "MGEF:DNAM", "MGEF:FULL", "PERK:FULL", "PERK:DESC" ,"PERK:EPF2", "SHOU:FULL", "SHOU:DESC",
        "SPEL:DESC", "SPEL:FULL", "AVIF:FULL", "AVIF:DESC", "PERK:EPFD"
    ],
    "物品.json": [
        "ACTI:FULL", "ACTI:RNAM", "ALCH:FULL", "AMMO:FULL",
        "ARMO:DESC", "ARMO:FULL", "CONT:FULL", "INGR:FULL",
        "KEYM:FULL", "MISC:FULL", "SLGM:FULL", "TREE:FULL",
        "WEAP:DESC", "WEAP:FULL", "PROJ:FULL", "FLOR:FULL"
    ],
    "过场.json": ["LSCR:DESC"]
}
