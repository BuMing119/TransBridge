...
公开页面记录 With Light 在 2025-01-15 首次上传、Nexus 175184 在 2026-03-21 首次上传。把这个
在先/在后关系与统计结果合并后，本审计确认两者存在大规模、系统性的文本继承关系，现有证据支持
的方向是 **With Light → Nexus 175184**。因此，Nexus 175184 被标记为疑似抄袭或未署名复用；
脚本本身不知道双方私下是否取得许可。
...
### 证据一：公开时间线确定在先作品与在后作品

- [With Light 文件页](https://www.nexusmods.com/skyrimspecialedition/mods/139134?tab=files)：最初上传于
  2025-01-15 11:08。
- [Nexus 175184 文件页](https://www.nexusmods.com/skyrimspecialedition/mods/175184?tab=files)：最初上传于
  2026-03-21 02:29。
- With Light 的公开发布早约 14 个月。结合下述文字证据，现有公开记录支持 With Light 为被继承来源、
  Nexus 175184 为在后继承或复用者。
...
- 保存发布时间、版本历史、页面说明、双方作者陈述以及是否取得许可的说明。
